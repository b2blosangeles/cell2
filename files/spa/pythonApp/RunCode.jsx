class RunCode extends React.Component {
    ...
    render() {
        var me = this;
        return(<div className="border border-secondary rounded m-0 p-2 bodyBox alert-secondary">
            <div className="container-fluid">
                <div className="row">
                    ...
                    <div className="col-sm-9 p-0 border border-dark rounded">
                        <div className="container ">
                            ...
                            <div className="row">
                                <div className="col-sm-12 p-3 border-top border-dark ng-light" style={{'min-height' : '28em'}}>
