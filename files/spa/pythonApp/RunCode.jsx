class RunCode extends React.Component {
    ...
    render() {
        var me = this;
        return(<div className="border border-warning rounded m-0 p-2 bodyBox">
            <div className="container-fluid">
                <div className="row">
                    ...
                    <div className="col-sm-8 p-0 border border-warning rounded bg-warning">
                        <div className="container ">
                            <div className="row">
                                <div className="col-sm-12 p-2 alert-success text-right">
